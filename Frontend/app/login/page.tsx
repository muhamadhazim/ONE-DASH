      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-8 md:px-16 lg:px-24 py-8 sm:py-12 bg-gradient-to-b from-gray-100/50 to-white">
        <div className="max-w-md w-full mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <Input
                ...
                className="h-12 sm:h-12 bg-gray-100 border-0 rounded-full px-5 sm:px-6 text-sm sm:text-base"
                required
              />
            </div>
            ...
            <div className="relative">
              <Input
                ...
                className="h-12 sm:h-12 bg-gray-100 border-0 rounded-full px-5 sm:px-6 pr-12 text-sm sm:text-base"
                required
              />
              <button
                type="button"
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-12 sm:h-12 bg-[#4A7DFF] hover:bg-[#3a6dee] text-white rounded-full text-sm sm:text-base font-medium active:scale-[0.98] transition-transform"
            >
              {loading ? (
                <>
          ...
          {/* <div className="mt-4 sm:mt-6 text-center">
            <Link href="#" className="text-xs sm:text-sm text-[#5DADE2] hover:underline">
              Forgot password?
            </Link>
          </div> */}
          ...
          <div className="mt-3 sm:mt-4 text-center">
            ...
            <Link href="/register" className="text-xs sm:text-sm text-[#5DADE2] hover:underline">
              Sign up
            </Link>
          </div>
